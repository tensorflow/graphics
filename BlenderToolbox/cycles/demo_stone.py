...
outputPath = './results/demo_stone.png'
...
noiseScale = 80
stoneRGBA = (199/255.0,175/255.0,147/255.0,255/255.0) 
meshColor = colorObj(stoneRGBA, 0.5, 1.4, 1.0, 0.0, 1.0)
AOStrength = 1.0
distortion = 0
setMat_stone(mesh, meshColor, noiseScale, distortion, AOStrength)
