...
def cartesian_to_spherical_coordinates(
    point_cartesian: type_alias.TensorLike,
    eps: type_alias.Float = None,
...
def double_factorial(n: type_alias.TensorLike) -> tf.Tensor:
...
def factorial(n: type_alias.TensorLike) -> tf.Tensor:
...
def spherical_to_cartesian_coordinates(
    point_spherical: type_alias.TensorLike,
    name: str = "spherical_to_cartesian_coordinates") -> tf.Tensor:
  """Function to transform Cartesian coordinates to spherical coordinates.
...
def square_to_spherical_coordinates(
    ...
    name: str = "math_square_to_spherical_coordinates") -> tf.Tensor:
