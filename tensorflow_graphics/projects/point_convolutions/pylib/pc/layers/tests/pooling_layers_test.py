...
from tensorflow_graphics.projects.point_convolutions.pylib.pc.layers import GlobalMaxPooling, GlobalAveragePooling
from tensorflow_graphics.projects.point_convolutions.pylib.pc.layers import MaxPooling, AveragePooling
