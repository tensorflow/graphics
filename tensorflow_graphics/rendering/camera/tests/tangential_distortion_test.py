...
class TangentialDistortionTest(test_case.TestCase):
  ...
  def test_both_projective_x_jacobian(self):
    ...
    distortion_coefficient_1 = _get_random_coefficient().astype(np.float64) * 0.5
    distortion_coefficient_2 = _get_random_coefficient().astype(np.float64) * 0.5
    distortion_coefficient_1 -= 0.25
    distortion_coefficient_2 -= 0.25

    def distortion_fn_x(projective_x):
      (distortion_x, _, _, _) = tangential_distortion.distortion_terms(
        projective_x,
        projective_y,
        distortion_coefficient_1,
        distortion_coefficient_2)
    ...
    def distortion_fn_y(projective_x):
      (_, distortion_y, _, _) = tangential_distortion.distortion_terms(
        projective_x,
        projective_y,
        distortion_coefficient_1,
        distortion_coefficient_2)
    ...
    self.assert_jacobian_is_correct_fn(
      distortion_fn_x, [projective_x], delta=1e-7, atol=1e-3)

    self.assert_jacobian_is_correct_fn(
      distortion_fn_y, [projective_x], delta=1e-7, atol=1e-3)
  ...
  def test_both_projective_y_jacobian(self):
    ...
    def distortion_fn_x(projective_y):
      (distortion_x, _, _, _) = tangential_distortion.distortion_terms(
        projective_x,
        projective_y,
        distortion_coefficient_1,
    ...
    def distortion_fn_y(projective_y):
      (_, distortion_y, _, _) = tangential_distortion.distortion_terms(
        projective_x,
        projective_y,
        distortion_coefficient_1,
    ...
    self.assert_jacobian_is_correct_fn(
      distortion_fn_x, [projective_y], delta=1e-7, atol=1e-3)

    self.assert_jacobian_is_correct_fn(
      distortion_fn_y, [projective_y], delta=1e-7, atol=1e-3)
  ...
  def test_both_distortion_coefficient_1_jacobian(self):
    ...
    def distortion_fn_x(distortion_coefficient_1):
      (distortion_x, _, _, _) = tangential_distortion.distortion_terms(
        projective_x,
        projective_y,
        distortion_coefficient_1,
    ...
    def distortion_fn_y(distortion_coefficient_1):
      (_, distortion_y, _, _) = tangential_distortion.distortion_terms(
        projective_x,
        projective_y,
        distortion_coefficient_1,
    ...
    self.assert_jacobian_is_correct_fn(
      distortion_fn_x, [distortion_coefficient_1], delta=1e-7, atol=1e-3)

    self.assert_jacobian_is_correct_fn(
      distortion_fn_y, [distortion_coefficient_1], delta=1e-7, atol=1e-3)
  ...
  def test_both_distortion_coefficient_2_jacobian(self):
    ...
    def distortion_fn_x(distortion_coefficient_2):
      (distortion_x, _, _, _) = tangential_distortion.distortion_terms(
        projective_x,
        projective_y,
        distortion_coefficient_1,
    ...
    def distortion_fn_y(distortion_coefficient_2):
      (_, distortion_y, _, _) = tangential_distortion.distortion_terms(
        projective_x,
        projective_y,
        distortion_coefficient_1,
    ...
    self.assert_jacobian_is_correct_fn(
      distortion_fn_x, [distortion_coefficient_2], delta=1e-7, atol=1e-3)

    self.assert_jacobian_is_correct_fn(
      distortion_fn_y, [distortion_coefficient_2], delta=1e-7, atol=1e-3)
